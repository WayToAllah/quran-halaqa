...
export const SURAS: ReadonlyArray<SuraInfo> = [
  ...
  { name: 'النساء', count: 176, pageStart: 77, pageEnd: 106 },
  ...
  { name: 'يونس', count: 109, pageStart: 208, pageEnd: 221 },
  { name: 'هود', count: 123, pageStart: 221, pageEnd: 235 },
  { name: 'يوسف', count: 111, pageStart: 235, pageEnd: 248 },
  { name: 'الرعد', count: 43, pageStart: 249, pageEnd: 255 },
  { name: 'إبراهيم', count: 52, pageStart: 255, pageEnd: 261 },
  { name: 'الحجر', count: 99, pageStart: 262, pageEnd: 267 },
  ...
  { name: 'مريم', count: 98, pageStart: 305, pageEnd: 312 },
  ...
  { name: 'الشورى', count: 53, pageStart: 483, pageEnd: 489 },
  ...
  { name: 'الأحقاف', count: 35, pageStart: 502, pageEnd: 506 },
  ...
  { name: 'الطور', count: 49, pageStart: 523, pageEnd: 525 },
  ...
  { name: 'الحشر', count: 24, pageStart: 545, pageEnd: 548 },
  ...
  { name: 'الانشقاق', count: 25, pageStart: 589, pageEnd: 589 },
  { name: 'البروج', count: 22, pageStart: 590, pageEnd: 590 },
  { name: 'الطارق', count: 17, pageStart: 591, pageEnd: 591 },
  { name: 'الأعلى', count: 19, pageStart: 591, pageEnd: 592 },
  { name: 'الغاشية', count: 26, pageStart: 592, pageEnd: 592 },
  { name: 'الفجر', count: 30, pageStart: 593, pageEnd: 594 },
  { name: 'البلد', count: 20, pageStart: 594, pageEnd: 594 },
  ...
  { name: 'البينة', count: 8, pageStart: 598, pageEnd: 599 },
  { name: 'الزلزلة', count: 8, pageStart: 599, pageEnd: 599 },
  { name: 'العاديات', count: 11, pageStart: 599, pageEnd: 600 },
